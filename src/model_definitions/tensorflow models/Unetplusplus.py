...
def model(img_rows, img_cols, color_type=1, num_class=1, deep_supervision=False):
    ...
    # else:
    #   bn_axis = 1
    #   inputs = Input(shape=(color_type, img_rows, img_cols), name='main_input')
    bn_axis = 3
    inputs = Input((256, 256, 1))
    # img_input = layers.Input((img_rows, img_cols, 1), name='main_input')
