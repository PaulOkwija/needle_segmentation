...
import torch
from model_definitions.squeeze_extractor import *
...
class UnetWithEncoder(torch.nn.Module):
    ...
    def __init__(self, n_classes, pretrained_model: SqueezeExtractor, batch_norm=True):
        ...
        self.features = pretrained_model.features.cuda()
    ...
    def forward(self, x):
        ...
        copy_idx = 0
        self.features[0] = nn.Conv2d(1, 64, 3, padding = (1,1))
...
from model_definitions.vgg import *
from model_definitions.resnet import *
from model_definitions.mobilenet import *
